            ...
            <div className='flex justify-between bg-[#9b9b9b2c] shadow-md px-3 py-2'>
                ...
                <div className='flex items-center gap-x-2 md:gap-x-5'>
                    ...
                    <div className='w-24 md:w-60 flex flex-col items-center gap-x-2'>
                        <input type="text" className='w-full md:text-base text-[12px] px-1 md:px-3 md:py-1 bg-transparent outline-none border-b-2 border-[#7c7c7c5c] border-dashed' />
                        <input type="number" className='w-full text-[12px] md:text-base md:px-3 md:py-1 bg-transparent outline-none border-b-2 border-[#7c7c7c5c] border-dashed' />
                        <input type="text" className='w-full px-1 md:px-3 md:py-1 text-[12px] md:text-base bg-transparent outline-none border-b-2 border-[#7c7c7c5c] border-dashed' />
                    </div>
                </div>
            ...
            <div className='flex justify-between items-center py-1 px-3'>
                ...
                <div>
                    <p className='md:text-lg text-[12px] font-semibold text-blue-600 md:font-bold'>
                        সিরিয়াল নং: <span className='font-semibold'>{serialNumber}</span>
                    </p>
                </div>
